          ...
          <div>
            ...
            <ul className="space-y-3">
              {['Features', 'Pricing', 'Integrations', 'API'].map((item, index) => (
                <li key={index}>
                  <a href="#" className="text-text-secondary hover:text-accent transition-colors duration-200 cursor-pointer">{item}</a>
                </li>
              ))}
            </ul>
          </div>
        ...
        <div className="flex flex-col sm:flex-row justify-between items-center pt-8 border-t border-secondary">
          ...
          {['github'].map((social, index) => (
            <a 
              ...
              className="w-10 h-10 bg-surface rounded-lg flex items-center justify-center text-text-secondary hover:text-accent hover:bg-accent/10 transition-all duration-200 cursor-pointer"
            >
